...
# Setting PATH to dotfiles
export DOTFILES="$HOME/.dotfiles"

# Virtual env name for Zsh Python plugin
...
# Variable for storing the brew prefix
HOMEBREW_PREFIX=$(brew --prefix)

# Generate the kubectl completion script for Zsh
source <(kubectl completion zsh)

# Generate the kubie completion script for Zsh
...
# Generate the stern completion script for Zsh
...
__aws_sso_profile_complete() {
    ...
    _multi_parts : "($(${HOMEBREW_PREFIX}/bin/aws-sso ${=_args} list --csv Profile))"
}
...
aws-sso-profile() {
    ...
    eval $(${HOMEBREW_PREFIX}/bin/aws-sso ${=_args} eval -p "$1")
...
aws-sso-clear() {
    ...
    eval $(${HOMEBREW_PREFIX}/bin/aws-sso ${=_args} eval -c)
}

compdef __aws_sso_profile_complete aws-sso-profile
complete -C ${HOMEBREW_PREFIX}/bin/aws-sso aws-sso
